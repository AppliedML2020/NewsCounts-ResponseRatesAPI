...
With the daily state response data we can find out, for example, which New York counties have higher response rates and which counties are doing worst by the date this document is created (March 26).
...
By having the daily data we can do more interesting things, such as time series to look for trends in the response rates. For this example I am going to compare the cumulative response rate for the states of California, New York, Pennsylvania and Alaska.
